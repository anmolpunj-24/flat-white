...
export default function PrivacyPolicy() {
  return (
    <div className="flex flex-col xl:flex-row gap-[32px] lg:gap-[40px] xl:gap-[100px] h-min px-[20px] lg:px-[40px] xl:px-[124px] pt-[40px] lg:pt-[92px] xl:pt-[92px] pb-[60px] lg:pb-[92px] xl:pb-[92px] max-w-[1440px] mx-auto">
      <SectionTag
        ...
        animation={true}
      />
      <div className="flex flex-col gap-[32px] lg:gap-[46px]">
        <div className="flex flex-col gap-[24px] lg:gap-[46px] w-full h-min">
          <SectionHeading
        ...
        <div className="flex flex-col gap-[20px] lg:gap-[32px] w-full h-min">
          <SectionHeading
            fontSize={`text-[28px] lg:text-[30px] xl:text-[32px]`}
            color={`#111`}
            letterSpacing={`tracking-[-0.06em]`}
