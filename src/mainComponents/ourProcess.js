...
export default function OurProcess() {
  ...
  return (
    <div className="px-[12px]" id="process">
      <div className="bg-[#657084] w-full flex flex-col h-min pt-[164px] px-[112px] rounded-[12px]">
        <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-[80px] items-center">
          <div className="flex flex-col gap-[146px] w-full max-w-[940px]">
            <SectionTag
              heading={`/  Our process`}
              bgColor={`#747e90`}
              textColor={`#fff`}
