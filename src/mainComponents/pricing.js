...
export default function Pricing() {
  return (
    ...
    >
      <span className="absolute top-[-10px] sm:top-[-25px] md:top-[-30px] lg:top-[-5px] left-1/2 -translate-x-1/2 text-center text-[9em] sm:text-[12em] md:text-[14.5em] lg:text-[19em] xl:text-[22.5em] leading-none font-[600] tracking-[-0.6px] bg-gradient-to-b from-[#9199a9]/20 to-[#9199a9]/2 bg-clip-text text-transparent pointer-events-none select-none">
        Pricing
      </span>
