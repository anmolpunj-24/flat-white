    ...
    <div className="p-[32px] flex flex-col justify-between rounded-[12px] h-full w-full bg-[#ffffff0a] min-h-[500px]">
      <div className="flex h-min gap-[12px] pb-[42px] items-center justify-between">
        <div className="items-center gap-[10px]">
          <h4 className="text-[32px] text-white">Emma Carter</h4>
          <div className="flex gap-[8px]">
            <p className="uppercase text-[12px] rounded-[99px] px-[12px] py-[6px] bg-[#222631] w-min h-min text-white whitespace-pre">
              Managing Partner
            </p>
            <p className="uppercase text-[12px] rounded-[99px] px-[12px] py-[6px] bg-[#222631] w-min h-min text-white whitespace-pre">
              London
      ...
      <p className="text-[16px] leading-[1.4em] tracking-[-0.02em] whitespace-pre-wrap break-words text-white">
